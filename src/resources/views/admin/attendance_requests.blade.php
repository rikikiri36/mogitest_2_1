...
<div class="header__link">
  ...
  <a class="header__link link" href="/admin/stamp_correction_request/list?tab=pending">申請</a>
  ...
  @else
    ...
    @foreach($requestLists as $requestList)
      <tr>
        ...
        <td>
          <a href="/stamp_correction_request/approve/{{$requestList->detail_id}}" class="detail__link">詳細</a></td>
        </tr>
    @endforeach
    </tbody>
    </table>
